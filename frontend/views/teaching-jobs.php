            ...
            <div class="col-lg-10">
                <form action="/" id="contactForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Address">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Town">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Nationality">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Native language">
                            </div>
                        </div>
                    </div>
